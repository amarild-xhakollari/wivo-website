...
import { Palette, Code2, Smartphone, Bot, MessageSquare, MapPin, ArrowRight } from "lucide-react"
...
const services = [
  ...
  },
  {
    ...
    description:
      "Get found by local customers searching on Google and Google Maps. We optimise your presence so you rank where it matters most.",
    tags: ["Local SEO", "Google Maps", "Google Business", "Rankings"],
    icon: MapPin,
    color: "gold" as const,
    href: "/services/seo-google-maps",
  },
]
...
function ServiceRow({
  ...
  return (
    ...
    >
      <Link
        href={service.href}
        className={`group relative flex items-start gap-6 lg:gap-10 py-8 px-6 lg:px-8 rounded-2xl transition-colors duration-300 ${colors.row}`}
...
export function ServicesSection() {
  ...
  return (
    <section id="services" className="relative py-10 lg:py-14 bg-background overflow-hidden">
